...
async function sendNewMail(email, title, body) {
  var transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "virtualworking02@gmail.com",
      pass: "ejmywfevykissljf",
    },
  });
  ...
  let htmlTemplate =
    ...
    <h1 style='color:gray'>Virtual Exchange</h1>
    ...
    <p style='margin:0 auto; margin-top:5px; color:gray;'>Virtual Exchange</p>
    <p style='margin:0 auto; margin-top:5px; color:gray;'>
    Lahore, Pakistan
    </p>

    <p style='margin:0 auto; margin-top:5px; color:gray;'>11232241234</br>
    ...
    <p style='margin:0 auto; margin-top:5px; margin-bottom:15px; color:gray;'>© 2022 Virtual Exchange. All rights reserved.</p>
    </div>`;
  var mailOptions = {
    from: "virtualworking02@gmail.com",
    to: email,
    subject: title,
    html: htmlTemplate,
  };
