    ...
    if (user != null) {
      ...
      let timezoneList = [
        ...
        },
        {
          ...
          code: "AL",
          gmt: "(UTC+01:00)",
          moment: "Europe/Tirane",
        },
        {
          name: "Algeria",
          code: "DZ",
          gmt: "(UTC+01:00)",
          moment: "Africa/Algiers",
        },
        {
          name: "Argentina",
          code: "AR",
          gmt: "(UTC-03:00)",
          moment: "America/Argentina/Buenos_Aires",
        },
        {
          name: "Armenia",
          code: "AM",
        ...
        },
        {
          ...
          code: "BE",
          gmt: "(UTC+01:00)",
          moment: "Europe/Brussels",
        },
        {
          name: "Belize",
          code: "BZ",
          gmt: "(UTC-06:00)",
          moment: "America/Belize",
        },
        {
          name: "Bhutan",
          code: "BT",
        ...
        },
        {
          ...
          code: "BO",
          gmt: "(UTC-04:00)",
          moment: "America/La_Paz",
        },
        {
          name: "Bosnia and Herzegovina",
          code: "BA",
          gmt: "(UTC+01:00)",
          moment: "Europe/Sarajevo",
        },
        {
          name: "Botswana",
          code: "BW",
          gmt: "(UTC+02:00)",
          moment: "Africa/Gaborone",
        },
        {
          name: "Brazil",
          code: "BR",
          gmt: "(UTC-02:00)",
          moment: "America/Sao_Paulo",
        },
        {
          name: "Brunei",
          code: "BN",
        ...
        },
        {
          ...
          code: "KH",
          gmt: "(UTC+07:00)",
          moment: "Asia/Phnom_Penh",
        },
        {
          name: "Cameroon",
          code: "CM",
          gmt: "(UTC+01:00)",
          moment: "Africa/Douala",
        },
        {
          name: "Canada",
          code: "CA",
          gmt: "(UTC-03:30)",
          moment: "America/St_Johns",
        },
        {
          name: "Chile",
          code: "CL",
          gmt: "(UTC-04:00)",
          moment: "America/Santiago",
        },
        {
          name: "China",
          code: "CN",
          gmt: "(UTC+08:00)",
          moment: "Asia/Shanghai",
        },
        {
          name: "Colombia",
          code: "CO",
          gmt: "(UTC-05:00)",
          moment: "America/Bogota",
        },
        {
          name: "Congo (DRC)",
          code: "CD",
          gmt: "(UTC+01:00)",
          moment: "Africa/Kinshasa",
        },
        {
          name: "Costa Rica",
          code: "CR",
          gmt: "(UTC-06:00)",
          moment: "America/Costa_Rica",
        },
        {
          name: "Côte d’Ivoire",
          code: "CI",
          gmt: "(UTC+00:00)",
          moment: "Africa/Abidjan",
        },
        {
          name: "Croatia",
          code: "HR",
          gmt: "(UTC+01:00)",
          moment: "Europe/Zagreb",
        },
        {
          name: "Cuba",
          code: "CU",
          gmt: "(UTC-05:00)",
          moment: "America/Havana",
        },
        {
          name: "Czech Republic",
          code: "CZ",
          gmt: "(UTC+01:00)",
          moment: "Europe/Prague",
        },
        {
          name: "Denmark",
          code: "DK",
          gmt: "(UTC+01:00)",
          moment: "Europe/Copenhagen",
        },
        {
          name: "Djibouti",
          code: "DJ",
          gmt: "(UTC+03:00)",
          moment: "Africa/Djibouti",
        },
        {
          name: "Dominican Republic",
          code: "DO",
          gmt: "(UTC-04:00)",
          moment: "America/Santo_Domingo",
        },
        {
          name: "Ecuador",
          code: "EC",
          gmt: "(UTC-05:00)",
          moment: "America/Guayaquil",
        },
        {
          name: "Egypt",
          code: "EG",
        ...
        },
        {
          ...
          code: "SV",
          gmt: "(UTC-06:00)",
          moment: "America/El_Salvador",
        },
        {
          name: "Eritrea",
          code: "ER",
          gmt: "(UTC+03:00)",
          moment: "Africa/Asmara",
        },
        {
          name: "Estonia",
          code: "EE",
          gmt: "(UTC+02:00)",
          moment: "Europe/Tallinn",
        },
        {
          name: "Ethiopia",
          code: "ET",
          gmt: "(UTC+03:00)",
          moment: "Africa/Addis_Ababa",
        },
        {
          name: "Faroe Islands",
          code: "FO",
          gmt: "(UTC+00:00)",
          moment: "Atlantic/Faroe",
        },
        {
          name: "Finland",
          code: "FI",
          gmt: "(UTC+02:00)",
          moment: "Europe/Helsinki",
        },
        {
          name: "France",
          code: "FR",
        ...
        },
        {
          ...
          code: "DE",
          gmt: "(UTC+01:00)",
          moment: "Europe/Berlin",
        },
        {
          name: "Greece",
          code: "GR",
          gmt: "(UTC+02:00)",
          moment: "Europe/Athens",
        },
        {
          name: "Greenland",
          code: "GL",
          gmt: "(UTC-03:00)",
          moment: "America/Godthab",
        },
        {
          name: "Guatemala",
          code: "GT",
          gmt: "(UTC-06:00)",
          moment: "America/Guatemala",
        },
        {
          name: "Haiti",
          code: "HT",
          gmt: "(UTC-05:00)",
          moment: "America/Port-au-Prince",
        },
        {
          name: "Honduras",
          code: "HN",
          gmt: "(UTC-06:00)",
          moment: "America/Tegucigalpa",
        },
        {
          name: "Hong Kong SAR",
          code: "HK",
          gmt: "(UTC+08:00)",
          moment: "Asia/Hong_Kong",
        },
        {
          name: "Hungary",
          code: "HU",
          gmt: "(UTC+01:00)",
          moment: "Europe/Budapest",
        },
        {
          name: "Iceland",
          code: "IS",
          gmt: "(UTC+00:00)",
          moment: "Atlantic/Reykjavik",
        },
        {
          name: "India",
          code: "IN",
        ...
        },
        {
          ...
          code: "IE",
          gmt: "(UTC+00:00)",
          moment: "Europe/Dublin",
        },
        {
          name: "Israel",
          code: "IL",
          gmt: "(UTC+02:00)",
          moment: "Asia/Jerusalem",
        },
        {
          name: "Italy",
          code: "IT",
        ...
        },
        {
          ...
          code: "LT",
          gmt: "(UTC+02:00)",
          moment: "Europe/Vilnius",
        },
        {
          name: "Luxembourg",
          code: "LU",
          gmt: "(UTC+01:00)",
          moment: "Europe/Luxembourg",
        },
        {
          name: "Macao SAR",
          code: "MO",
        ...
        },
        {
          ...
          code: "MK",
          gmt: "(UTC+01:00)",
          moment: "Europe/Skopje",
        },
        {
          name: "Malaysia",
          code: "MY",
          gmt: "(UTC+08:00)",
          moment: "Asia/Kuala_Lumpur",
        },
        {
          name: "Maldives",
          code: "MV",
          gmt: "(UTC+05:00)",
          moment: "Indian/Maldives",
        },
        {
          name: "Mali",
          code: "ML",
          gmt: "(UTC+00:00)",
          moment: "Africa/Bamako",
        },
        {
          name: "Malta",
          code: "MT",
        ...
        },
        {
          ...
          code: "MX",
          gmt: "(UTC-06:00)",
          moment: "America/Mexico_City",
        },
        {
          name: "Moldova",
          code: "MD",
          gmt: "(UTC+02:00)",
          moment: "Europe/Chisinau",
        },
        {
          name: "Monaco",
          code: "MC",
          gmt: "(UTC+01:00)",
          moment: "Europe/Monaco",
        },
        {
          name: "Mongolia",
          code: "MN",
          gmt: "(UTC+08:00)",
          moment: "Asia/Ulaanbaatar",
        },
        {
          name: "Montenegro",
          code: "ME",
          gmt: "(UTC+01:00)",
          moment: "Europe/Podgorica",
        },
        {
          name: "Morocco",
          code: "MA",
          gmt: "(UTC+00:00)",
          moment: "Africa/Casablanca",
        },
        {
          name: "Myanmar",
          code: "MM",
        ...
        },
        {
          ...
          code: "NP",
          gmt: "(UTC+05:45)",
          moment: "Asia/Kathmandu",
        },
        {
          name: "Netherlands",
          code: "NL",
          gmt: "(UTC+01:00)",
          moment: "Europe/Amsterdam",
        },
        {
          name: "New Zealand",
          code: "NZ",
          gmt: "(UTC+12:00)",
          moment: "Pacific/Auckland",
        },
        {
          name: "Nicaragua",
          code: "NI",
          gmt: "(UTC-06:00)",
          moment: "America/Managua",
        },
        {
          name: "Nigeria",
          code: "NG",
        ...
        },
        {
          ...
          code: "PA",
          gmt: "(UTC-05:00)",
          moment: "America/Panama",
        },
        {
          name: "Paraguay",
          code: "PY",
          gmt: "(UTC-04:00)",
          moment: "America/Asuncion",
        },
        {
          name: "Peru",
          code: "PE",
        ...
        },
        {
          ...
          code: "PL",
          gmt: "(UTC+01:00)",
          moment: "Europe/Warsaw",
        },
        {
          name: "Portugal",
          code: "PT",
          gmt: "(UTC+00:00)",
          moment: "Europe/Lisbon",
        },
        {
          name: "Puerto Rico",
          code: "PR",
          gmt: "(UTC-04:00)",
          moment: "America/Puerto_Rico",
        },
        { name: "Qatar", code: "QA", gmt: "(UTC+03:00)", moment: "Asia/Qatar" },
        {
          ...
          code: "RE",
          gmt: "(UTC+04:00)",
          moment: "Indian/Reunion",
        },
        {
          name: "Romania",
          code: "RO",
          gmt: "(UTC+02:00)",
          moment: "Europe/Bucharest",
        },
        {
          name: "Russia",
          code: "RU",
          gmt: "(UTC+02:00)",
          moment: "Europe/Moscow",
        },
        {
          name: "Rwanda",
          code: "RW",
          gmt: "(UTC+02:00)",
          moment: "Africa/Kigali",
        },
        {
          name: "Saudi Arabia",
          code: "SA",
        ...
        },
        {
          ...
          code: "RS",
          gmt: "(UTC+01:00)",
          moment: "Europe/Belgrade",
        },
        {
          name: "Singapore",
          code: "SG",
          gmt: "(UTC+08:00)",
          moment: "Asia/Singapore",
        },
        {
          name: "Slovakia",
          code: "SK",
          gmt: "(UTC+01:00)",
          moment: "Europe/Bratislava",
        },
        {
          name: "Slovenia",
          code: "SI",
          gmt: "(UTC+01:00)",
          moment: "Europe/Ljubljana",
        },
        {
          name: "Somalia",
          code: "SO",
          gmt: "(UTC+03:00)",
          moment: "Africa/Mogadishu",
        },
        {
          name: "South Africa",
          code: "ZA",
          gmt: "(UTC+02:00)",
          moment: "Africa/Johannesburg",
        },
        {
          name: "Spain",
          code: "ES",
        ...
        },
        {
          ...
          code: "SE",
          gmt: "(UTC+01:00)",
          moment: "Europe/Stockholm",
        },
        {
          name: "Switzerland",
          code: "CH",
          gmt: "(UTC+01:00)",
          moment: "Europe/Zurich",
        },
        {
          name: "Syria",
          code: "SY",
          gmt: "(UTC+02:00)",
          moment: "Asia/Damascus",
        },
        {
          name: "Taiwan",
          code: "TW",
        ...
        },
        {
          ...
          code: "TR",
          gmt: "(UTC+02:00)",
          moment: "Europe/Istanbul",
        },
        {
          name: "Turkmenistan",
          code: "TM",
          gmt: "(UTC+05:00)",
          moment: "Asia/Ashgabat",
        },
        {
          name: "Ukraine",
          code: "UA",
        ...
        },
        {
          ...
          code: "GB",
          gmt: "(UTC+00:00)",
          moment: "Europe/London",
        },
        {
          name: "United States",
          code: "US",
          gmt: "(UTC-05:00)",
          moment: "America/New_York",
        },
        {
          name: "Uruguay",
          code: "UY",
          gmt: "(UTC-03:00)",
          moment: "America/Montevideo",
        },
        {
          name: "Uzbekistan",
          code: "UZ",
          gmt: "(UTC+05:00)",
          moment: "Asia/Tashkent",
        },
        {
          name: "Venezuela",
          code: "VE",
          gmt: "(UTC-04:00)",
          moment: "America/Caracas",
        },
        {
          name: "Vietnam",
          code: "VN",
          gmt: "(UTC+07:00)",
          moment: "Asia/Ho_Chi_Minh",
        },
      ...
      if (loginLogCheck == null) {
        ...
        if (user.email != undefined && user.email != "" && user.email != null) {
          ...
          await mailer.sendMail(
            user.email,
            "New Login",
            "An unusual login has been detected from your account. </br><p style='font-weight:bold'>Pin:" +
              verificationPin +
              "</p> If you did not authorize this login, please contact support immediately."
          );
        } else {
          ...
          if (
            ...
            let smsText =
              "An unusual login has been detected from your account. Verification Pin:" +
              verificationPin +
